...
/** A file within a [GroupEntry]; [nameHash] is unused when the owning index is unnamed. */
data class FileEntry(val id: Int, val nameHash: Int = 0)

/**
 * One archive entry inside a JS5 reference table. Size and name fields are unused when their
 * corresponding index flags are absent.
 */
