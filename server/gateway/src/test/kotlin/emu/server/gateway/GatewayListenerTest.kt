        ...
        val listener =
            GatewayListener.bind(
                ...
                GatewayRoutes(
                    js5Opcode = 15,
                    loginOpcode = 14,
                    js5 = GatewayRoute { _, _ -> routed.complete("js5") },
                    login = GatewayRoute { _, _ -> routed.complete("login") },
                ),
            )
        ...
        val listener =
            GatewayListener.bind(
                ...
                GatewayRoutes(
                    js5Opcode = 15,
                    loginOpcode = 14,
                    js5 = GatewayRoute { _, _ -> },
                    login = GatewayRoute { _, _ -> routed.complete(Unit) },
                ),
            )
        val listenerJob = launch { listener.run() }
        val selector = SelectorManager(Dispatchers.IO)
        ...
        val listener =
            GatewayListener.bind(
                ...
                GatewayRoutes(
                    js5Opcode = 15,
                    loginOpcode = 14,
                    js5 = GatewayRoute { _, _ -> js5Routed.complete(Unit) },
                    login = GatewayRoute { _, _ ->
