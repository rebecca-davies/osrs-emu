...
/** Whether a player varp survives logout. Temporary varps are rebuilt by server state on login. */
enum class VarpScope { TEMPORARY, PERMANENT }

/** Client synchronization policy for a player varp. */
enum class VarpTransmit { NEVER, ON_CHANGE, ALWAYS }
