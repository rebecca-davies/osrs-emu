...
// success (rev239-login-facts.md §6); sent by Task 6's LoginHandler. Other explicitly handled codes
// are 15/21/23/29/61/64/69 — anything else falls through to the client's error table.
